...
<main role="main" class="m-2">
  ...
  <div class="container-fluid bg-light border border-dark rounded amule-log">

    <div class="row p-1 border-bottom border-dark">
      <div class="col-auto">
        <h5><strong>aMule Log</strong></h5>
      </div>
<?php
  if ( $_SESSION["guest_login"] == 0 ) {
  echo '<div class="col-auto">';
  echo '<a href="amuleweb-main-log.php?rstlog=1" onclick="' . "return confirm('Do you really want to reset aMule log?')" . '">(Reset)</a>';
  echo '</div>';
  }
?>
    </div>
    ...
    <div class="row p-1 border-bottom border-dark">
      <div class="col">
        <pre><?php echo amule_get_log($HTTP_GET_VARS['rstlog']); ?></pre>
      </div>
    </div>

    <div class="row p-1 border-bottom border-dark">
      <div class="col-auto">
        <h5><strong>Serverinfo</strong></h5>
      </div>
<?php
  if ( $_SESSION["guest_login"] == 0 ) {
  echo '<div class="col-auto">';
  echo '<a href="amuleweb-main-log.php?rstsrv=1" onclick="' . "return confirm('Do you really want to reset Serverinfo?')" . '">(Reset)</a>';
  echo '</div>';
  }
?>
    </div>
    ...
    <div class="row p-1 border-bottom border-dark">
      <div class="col">
        <pre><?php echo amule_get_serverinfo($HTTP_GET_VARS['rstsrv']); ?></pre>
      </div>
    </div>
  </div>
